...
class UserController extends Controller
{
    ...
    public function profileEdit($id = null){
        ...
        $zips = DB::table('zips')->select('zip')->where('city', $old_city)->get();

        return view('admin.profile_edit', compact('title', 'user', 'states', 'cities', 'zips'));
    }
    ...
    public function profileEditPost($id = null, Request $request)
    {
        ...
        $inputs = array_except($request->input(), ['_token', 'photo', 'experience']);
        
        $res = Http::post('https://sliced.app/modules/sliced.money/users/index.php', [
