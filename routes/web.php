...
Route::post('get-city-by-state', ['as'=>'get_city_by_state', 'uses' => 'CampaignsController@getCityByState']);
Route::post('get-zips-by-city', ['as'=>'get_zips_by_city', 'uses' => 'CampaignsController@getZipsByCity']);
...
Route::group(['prefix'=>'dashboard', 'middleware' => 'auth'], function() {
    ...
    Route::group(['prefix'=>'my_campaigns'], function(){
        ...
        Route::post('edit_campaign/{id}', [ 'as' => 'campaings.update', 'uses' => 'CampaignsController@update']);
    ...
    Route::group(['middleware' => 'admin'], function() {
        ...
        Route::group(['prefix'=>'users'], function(){
            ...
            Route::delete('/{id}', ['as'=>'users.delete', 'uses' => 'UserController@deleteUser']);
        });
