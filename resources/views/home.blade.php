            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="jumbotron-button-wrap">
                        <a class="btn btn-lg-outline" href="{{route('browse_categories')}}" style="width: 264px;">@lang('app.support_campaigns')</a>
                        <a class="btn btn-lg-filled" href="{{route('start_campaign')}}" style="width: 264px;">@lang('app.start_crowdfunding')</a>
                    </div>
                </div>
            </div>
        </div>
